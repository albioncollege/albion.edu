...
function theme_css() {
	...
	wp_enqueue_style('theme-styles', get_theme_file_uri('/dist/css/main.css?v=36'), [], null, 'screen');
}
...
// theme js
function theme_js() {
	wp_enqueue_script('theme-scripts', get_theme_file_uri('/dist/js/main.js?v=8'), [], null, true );
}
