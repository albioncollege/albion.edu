...
function _initMap() {
  _initMap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _yield$google$maps$im, Map, _yield$google$maps$im2, AdvancedMarkerElement, center, map, albionBounds, imageBounds, properties, clearMapSelection, locationMarkers, _iterator2, _step2, _loop3, menuElement, groupedLocations, _loop, _i, _Object$entries, adjustMap;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            center = {
              lat: 42.244132014018355,
              lng: -84.74260534813175
            };
            ...
            clearMapSelection = function clearMapSelection() {
              var _document$querySelect;
              clearSelection();
              (_document$querySelect = document.querySelector(".info-wrapper")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.classList.add("hide");
            };
            map.addListener("click", clearMapSelection);
            droneOverlay.addListener("click", clearMapSelection);
            locationMarkers = new WeakMap();
            ...
            menuElement = document.getElementById('map-menu');
            groupedLocations = groupLocationsByType(properties);
            _loop = function _loop() {
              var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
                icon = _Object$entries$_i[0],
                locations = _Object$entries$_i[1];
              ...
              locationList.id = "map-submenu-".concat(menuElement.children.length);
              ...
              subMenuButton.addEventListener("click", function () {
                var expanded = subMenuButton.getAttribute("aria-expanded") !== "true";
              ...
              try {
                var _loop2 = function _loop2() {
                  ...
                  locationButton.addEventListener("click", function () {
                    var marker = locationMarkers.get(location);
            ...
            for (_i = 0, _Object$entries = Object.entries(groupedLocations); _i < _Object$entries.length; _i++) {
              _loop();
            }
            ...
            adjustMap = function adjustMap(mode, amount) {
              switch (mode) {
                case "tilt":
...
function toggleHighlight(markerView, property) {
  ...
  addInfo(property);
  var activeHighlights = document.querySelectorAll(".highlight").length;
...
function buildContent(property) {
  ...
  content.innerHTML = "\n\t<div class=\"icon\">\n\t\t<span class=\"svgstore svgstore--icon-".concat(property.icon, "\">\n\t\t\t<svg>\n\t\t\t\t<title>").concat(property.icon, "</title>\n\t\t\t\t<use xlink:href=\"/wp-content/themes/albion/dist/img/svgstore.svg#icon-").concat(property.icon, "\"></use>\n\t\t\t</svg>\n\t\t</span>\n\t\t<span class=\"sr-only\">").concat(property.name, "</span>\n\t</div>\n\t<div class=\"details\">\n\t\t<div class=\"name\">").concat(property.name, "</div>\n\t</div>\n\t");
  return content;
}
function groupLocationsByType() {
  var locations = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  return locations.reduce(function (groups, location) {
    var icon = location.icon || "other";
    if (!groups[icon]) {
      groups[icon] = [];
    }
...
var menuButton = document.querySelector(".menu-wrapper button.menu");
var mapMenu = document.getElementById("map-menu");
if (menuButton && mapMenu) {
  var setMenuExpanded = function setMenuExpanded(expanded) {
  ...
  mapMenu.addEventListener("click", function (event) {
    var campusMap = mapMenu.closest(".campus-map");
    if (event.target.closest(".location-button") && campusMap.clientWidth < 800) {
      menuButton.focus();
      setMenuExpanded(false);
    }
  });
  menuButton.closest(".menu-wrapper").addEventListener("keydown", function (event) {
    if (event.key === "Escape") {
      setMenuExpanded(false);
      menuButton.focus();
    }
...
var featureContainers = document.querySelectorAll('.feature__component__v3');

// loop through the showcase containers (handles multiple showcases)
_toConsumableArray(featureContainers).forEach(function (featureContainer) {
  // get the showcase and controls
  var showcase = featureContainer.querySelector('.feature__grid__v3');
  var controls = featureContainer.querySelector('.feature__grid__controls');
  ...
  controls.querySelectorAll('div').forEach(function (control) {
  ...
  controls.querySelectorAll('a').forEach(function (control) {
    ...
    control.addEventListener('click', function (event) {
      ...
      if (this.className.match('next')) {
        ...
        var currentSlide = showcase.querySelector('.slide.active');
        var currentControl = controls.querySelector('a.active');
        ...
        var selectedControl = controls.querySelector('[data-slide="' + this.dataset.slide + '"]');
...
/***/ "./src/js/modules/_video_dialogue.js":
/*!*******************************************!*\
  !*** ./src/js/modules/_video_dialogue.js ***!
  \*******************************************/
/*! no exports provided */
...
document.querySelectorAll('button[href*="youtube.com/watch"],button[href*="youtube.com/short"],button[href*="youtu.be"]').forEach(function (link) {
  link.addEventListener("click", function (event) {
    var dialogElement = document.getElementById("dialog-wrapper");
    // Clear the dialog
    dialogElement.innerHTML = "";

    // Get the video id from the url
    var videoId = getYouTubeVideoId(this.getAttribute("href"));
...
function getYouTubeVideoId(url) {
  ...
  var match = parsedUrl.pathname.match(/^\/(?:embed|shorts)\/([^/?]+)/);
...
/* harmony import */ var _modules_posts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/_posts */ "./src/js/modules/_posts.js");
...
/* harmony import */ var _modules_button__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/_button */ "./src/js/modules/_button.js");
/* harmony import */ var _modules_button__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_modules_button__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _modules_classnotes__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/_classnotes */ "./src/js/modules/_classnotes.js");
/* harmony import */ var _modules_contacts__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/_contacts */ "./src/js/modules/_contacts.js");
/* harmony import */ var _modules_events__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/_events */ "./src/js/modules/_events.js");
/* harmony import */ var _modules_events__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_modules_events__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _modules_footer__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/_footer */ "./src/js/modules/_footer.js");
/* harmony import */ var _modules_footer__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_modules_footer__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _modules_feature__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/_feature */ "./src/js/modules/_feature.js");
/* harmony import */ var _modules_header__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/_header */ "./src/js/modules/_header.js");
/* harmony import */ var _modules_lightbox__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/_lightbox */ "./src/js/modules/_lightbox.js");
/* harmony import */ var _modules_lightbox__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_modules_lightbox__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var _modules_media__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/_media */ "./src/js/modules/_media.js");
/* harmony import */ var _modules_nav__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/_nav */ "./src/js/modules/_nav.js");
/* harmony import */ var _modules_sidebar__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/_sidebar */ "./src/js/modules/_sidebar.js");
/* harmony import */ var _modules_sidebar__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_modules_sidebar__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _modules_showcase__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/_showcase */ "./src/js/modules/_showcase.js");
/* harmony import */ var _modules_social__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./modules/_social */ "./src/js/modules/_social.js");
/* harmony import */ var _modules_splash__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./modules/_splash */ "./src/js/modules/_splash.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./modules/_tabs */ "./src/js/modules/_tabs.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(_modules_tabs__WEBPACK_IMPORTED_MODULE_24__);
/* harmony import */ var _modules_testimonial_slider__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./modules/_testimonial-slider */ "./src/js/modules/_testimonial-slider.js");
/* harmony import */ var _modules_campus_map__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./modules/_campus_map */ "./src/js/modules/_campus_map.js");
/* harmony import */ var _modules_video_dialogue__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./modules/_video_dialogue */ "./src/js/modules/_video_dialogue.js");
